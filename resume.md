...
- **Cooper / SberMarket (IBS)** (very similar to **Instacart**): production night LT (**23:00–03:00**): **~900 → 2600+ orders/h** (**+189%**), **0** customer incidents; **5000+** users; **~3900** HTTP req/s at 400% profile.
- **Rosgosstrakh / Guidewire (IBS):** **~165k ops/h** peak at **80%** profile; **15+** stubs; Oracle/PolicyCenter fixes before insurance launch.
...
- **Cooper / SberMarket** (very similar to **Instacart**) — production night LT (**23:00–03:00**), **0** incidents: orders **~900 → 2600+/h** (**+189%**); **5000+** users; **~3900** HTTP req/s at 400%; **30+** Gatling scenarios; **Kafka**, **PostgreSQL**, ELK.  
...
- **Corporate portal (IBS internal)** — **1C-Bitrix**: traffic-based profile; **~3×** headroom after **2×** CPU; AD vs non-AD login comparison.  
